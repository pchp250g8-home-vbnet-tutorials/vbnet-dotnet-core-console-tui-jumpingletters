JumpingLetters. VB.Net Tutorials. Platform DotNet Core. TUI. Advanced Console Features. Console Application.
...
JumpingLetters. Занятия по VB.Net. Платформа DotNet Core. Приложение с текстовым интерфейсом пользователя. 
